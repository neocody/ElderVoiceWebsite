...
import { Eye, EyeOff, Phone, Shield, Clock, Info, Heart } from "lucide-react";
        ...
        <div className="mb-8">
          <Link href="/">
            <div className="flex items-center gap-3 cursor-pointer group mb-6">
              <Heart 
                className="h-10 w-10 text-white fill-white transition-all group-hover:scale-110" 
              />
              <span className="text-2xl font-bold text-white transition-all group-hover:scale-105">
                Elder Voice
              </span>
            </div>
          </Link>
